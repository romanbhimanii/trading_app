...
class Positions {
  ...
  factory Positions.fromJson(Map<String, dynamic> json) {
    return Positions(
      ...
      sumOfTradedQuantityAndPriceBuy: double.parse(json['SumOfTradedQuantityAndPriceBuy']),
      sumOfTradedQuantityAndPriceSell: double.parse(json['SumOfTradedQuantityAndPriceSell']),
      ...
      sumOfTradedQuantityAndActualPriceBuy: json['sumOfTradedQuantityAndActualPriceBuy'].toDouble(),
      sumOfTradedQuantityAndActualPriceSell: json['sumOfTradedQuantityAndActualPriceSell'].toDouble(),
